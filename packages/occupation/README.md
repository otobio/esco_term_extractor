...
index, binary family-profile tables, binary family-token relevance tables,
binary alias-ngram artifacts, signal vocabulary, intent vocabulary, and role-head equivalences. The binary-cache backend can then
