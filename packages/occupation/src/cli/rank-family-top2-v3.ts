...
import {
  rankFamilyTop2V3,
  type FamilyTop2V3ClassifierQuery,
  type FamilyTop2V3FamilyHit,
  type FamilyTop2V3Result
} from './rank-family-top2-v3-core.js';
...
async function main(): Promise<void> {
  ...
  const query: FamilyTop2V3ClassifierQuery = {
    preparedQuery,
...
function formatResult(result: FamilyTop2V3Result, format: OutputFormat): string {
  if (format === 'json') {
...
function formatFamilyHit(family: FamilyTop2V3FamilyHit): string {
  return [
