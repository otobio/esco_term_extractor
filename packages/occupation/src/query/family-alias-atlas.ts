...
const FAMILY_ALIAS_ENTRIES: FamilyAliasEntry[] = [
...
const FAMILY_ALIAS_ENTRIES_BY_LOCALE: Record<SupportedQueryLocale, FamilyAliasEntry[]> = {
...
export function findFamilyAliasMatch(value: string, locale: SupportedQueryLocale): FamilyAliasMatch | null {
  ...
  let best: FamilyAliasMatch | null = null;
...
function comparePhraseMatch(left: FamilyAliasMatch, right: FamilyAliasMatch): number {
