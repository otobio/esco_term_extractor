...
export const PIPELINE_DEVELOPING_GOLDEN_CASES: GoldenCase[] = [
  {
    ...
    locale: 'en',
    description:
      'Generic occupational wrapper ("personnel") should not out-score the specific head word ("sales") in ngram_alias evidence. ' +
  ...
  },
  {
    ...
    locale: 'en',
    description:
      'Dental-office context should stay in the receptionist family and avoid drifting to unrelated admin or health-record roles.',
    expectation: {
      decisionType: 'family',
      topFamilyLabel: 'Client information workers',
      minimumConfidence: 0.55
  ...
  },
  {
    ...
    locale: 'en',
    description:
      'Retail-assistant wording should converge with the existing sales-assistant leaf instead of abstaining or drifting to creative families.',
    expectation: {
      decisionType: 'leaf',
      selectedLabel: 'sales assistant',
      topFamilyLabel: 'Shop salespersons',
  ...
  },
  {
    ...
    locale: 'en',
    description:
      'Aviation is domain context; compliance officer should prefer the regulatory/compliance branch rather than aviation-operations drift.',
    expectation: {
      decisionType: 'family',
...
export const PIPELINE_FAILURE_BASELINE_CASES: GoldenCase[] = [
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Sales counsellor wrongly resolves to insurance broker. Better direction: sales assistant / commercial sales representative.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'No CAD signal at all; wrongly resolves to computer-aided design operator. Better direction: clerical/online-shop/computer operator.',
    expectation: { decisionType: 'unresolved', minimumConfidence: 0 }
  },
  {
    ...
    locale: 'ro',
    description:
      'No mining context; wrongly resolves to mining electrician. Better direction: electrician / industrial maintenance electrician.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Title is installation/network/electrical technician, not inspector. Better direction: electrician / telecom/network technician.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'No clothing/development signal; wrongly resolves to clothing development manager. Better direction: management assistant / administrative assistant.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'No automotive-engine signal; wrongly resolves to motor vehicle engine tester. Better direction: product/quality inspection technician.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Bakery is not a refinery; wrongly resolves to refinery shift manager. Better direction: food-production/shift supervisor.',
    expectation: { decisionType: 'family', minimumConfidence: 0.4 }
  },
  {
    ...
    locale: 'ro',
    description:
      '"Engineer/technologist" is stronger evidence than generic technician. Better direction: food technologist / food engineer.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Romanian means interface/liaison with third parties/departments, not UI design. Better direction: administrative/coordinator/client-relations role.',
    expectation: { decisionType: 'unresolved', minimumConfidence: 0 }
  },
  {
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Mechanic repairs/maintains machinery; assembler is a different occupation. Better direction: machinery mechanic/repairer.',
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Generic hiring advert provides no occupation evidence and wrongly resolves to demolition supervisor. Should be rejected as insufficiently descriptive.',
    expectation: { decisionType: 'unresolved', minimumConfidence: 0 }
  },
  {
  ...
  },
  {
    ...
    locale: 'ro',
    description:
      'Completely unrelated result; wrongly resolves to specialist pharmacist. Better direction: electrical/electrical installation occupation.',
    expectation: { decisionType: 'family', topFamilyLabel: 'Electrical equipment installers and repairers', minimumConfidence: 0.4 }
  },
  {
...
function evaluateCase(goldenCase: GoldenCase, actual: GoldenCaseResult['actual']): string[] {
  ...
  if (
    expectation.selectedLeafLabel !== undefined &&
  ...
  if (
    expectation.selectedFamilyLabel !== undefined &&
  ...
  for (const spanExpectation of expectation.spanExpectations ?? []) {
    ...
    if (
      spanExpectation.selectedLeafLabel !== undefined &&
      normalizeLabel(spanActual.selectedLeafLabel) !== normalizeLabel(spanExpectation.selectedLeafLabel)
    ) {
      failures.push(
        `span "${spanExpectation.query}" selectedLeafLabel expected "${spanExpectation.selectedLeafLabel}", got "${spanActual.selectedLeafLabel ?? 'null'}"`
      );
    }

    if (
      spanExpectation.selectedFamilyLabel !== undefined &&
      normalizeLabel(spanActual.selectedFamilyLabel) !== normalizeLabel(spanExpectation.selectedFamilyLabel)
    ) {
      failures.push(
        `span "${spanExpectation.query}" selectedFamilyLabel expected "${spanExpectation.selectedFamilyLabel}", got "${spanActual.selectedFamilyLabel ?? 'null'}"`
      );
    }
...
function effectiveExpectationForEvaluation(goldenCase: GoldenCase): GoldenExpectation {
...
function normalizeDevelopingSelectionExpectation(expectation: GoldenExpectation): GoldenExpectation {
  ...
  return {
    ...
    selectedFamilyLabel:
      expectation.selectedFamilyLabel ??
...
function normalizeDevelopingSpanExpectation(expectation: GoldenSpanExpectation): GoldenSpanExpectation {
