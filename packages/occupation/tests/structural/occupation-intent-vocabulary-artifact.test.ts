...
import {
  ...
  type OccupationIntentVocabularyLocaleOverrides,
  type OccupationIntentVocabularyArtifactManifest
} from '../../src/runtime/occupation-intent-vocabulary-artifact.js';
import type { RuntimeSearchMetaRecord } from '../../src/runtime/occupation-search-meta-artifact.js';
import type { OccupationIntentVocabularyLocale } from '../../src/query/query-intent.js';

function record(overrides: Partial<RuntimeSearchMetaRecord>): RuntimeSearchMetaRecord {
  return {
    searchMetaId: 1,
    graphNodeId: 1,
...
test('intent vocabulary loader sanitizes contradictory locale records from disk', async () => {
  ...
  try {
    ...
    const manifest: OccupationIntentVocabularyArtifactManifest = {
