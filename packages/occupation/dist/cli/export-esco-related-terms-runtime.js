...
import { buildEscoRelatedTermsBinaryFiles, defaultEscoRelatedTermsManifestPath, ESCO_RELATED_TERMS_BINARY_SCHEMA_VERSION } from '../runtime/esco-related-terms-artifact.js';
...
function legacyEscoRelatedTermsFileNames(prefix) {
    return [
        `${prefix}.strings.bin`,
