...
async function main() {
    ...
    for (const [index, hit] of hits.entries()) {
        console.log(`${index + 1}. ${hit.canonicalLabel} score=${hit.score} cosine=${hit.cosine} coverage=${hit.usefulTokenCoverage} alias="${hit.alias}" role=${hit.aliasRole} family="${hit.familyLabel ?? 'n/a'}"`);
