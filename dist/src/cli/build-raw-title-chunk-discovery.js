...
import { annotateChunkCandidateStats, aggregateChunkFacts, chunkAnnotationsToCsvRows, chunkFactsToCsvRows, chunkStatsToCsvRows, discoverRawTitleChunkFacts, selectMonitorChunkAnnotations } from '../enrichment/title-chunk-discovery.js';
...
async function main() {
    ...
    const sourceRows = rows.filter((row) => Boolean(row));
