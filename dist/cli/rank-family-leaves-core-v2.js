...
import { ATOMIC_SPECIALIZATION_SYNONYMS, canonicalLeafSpecializationSlotComparison, detectLeafLevelKind, leafLevelKindsContradict, resolveLeafSpecializationKindsFromTokens, specializationKindAlignedWithQuery, specializationKindImpliedByQueryVenue, specializationKindSupportedByCapabilities } from '../runtime/occupation-leaf-structure-rules-v2.js';
...
const LEVEL_AUTHORITY_KINDS = new Set(['manager', 'director', 'chief']);
