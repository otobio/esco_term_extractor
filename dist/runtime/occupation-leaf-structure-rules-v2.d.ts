...
export declare function leafLevelKindsContradict(queryLevelKind: LeafLevelKind, leafLevelKind: LeafLevelKind): boolean;
export type SpecializationDimensionProfile = Map<string, number[]>;
export declare function buildSpecializationDimensionProfile(tokens: Set<string>): SpecializationDimensionProfile;
export declare function leafSpecializationDimensionProfile(canonicalTokens: Set<string>): SpecializationDimensionProfile;
export declare function querySpecializationDimensionProfile(preparedQuery: PreparedQuery): SpecializationDimensionProfile;
export declare function compareSpecializationDimensionProfiles(leafProfile: SpecializationDimensionProfile, queryProfile: SpecializationDimensionProfile): {
    contradictionCount: number;
    alignmentCount: number;
    unsupportedSpecificityCount: number;
};
