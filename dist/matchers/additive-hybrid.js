 ...
 */
import { exactClauses, fuzzyClauses, SOURCE_FIELDS, SPARSE_FIELD, topHits } from './strategy.js';
const FLOORS = {
    occupation: { term: 1, neural: 5.5 },
    capabilities: { term: 1, neural: 4.8 },
};
const DEFAULT_FLOORS = { term: 1, neural: 5.5 };
/**
...
const floorFor = (bucket) => FLOORS[bucket] ?? DEFAULT_FLOORS;
const accepts = (hit, floors) => hit.score >= (hit.termAnchored ? floors.term : floors.neural);
export const additiveHybridStrategy = {
