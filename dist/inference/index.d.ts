...
export declare const FINITE_INFERENCE_BUCKETS: readonly BucketName[];
export declare function hasFiniteInferer(bucket: BucketName): boolean;
export declare function inferFiniteBucket(bucket: BucketName, clauses: Clause[], languages?: SupportedLanguage[], opts?: FiniteInferOptions): InferredTerm[];
export declare function finiteInferenceLanguages(locale: string | undefined): SupportedLanguage[] | undefined;
export declare function isSupportedLanguage(locale: string): locale is SupportedLanguage;
