...
const RECORDS = [
    ...
    r('sector', 'en', ['Agriculture, Fishing & Forestry', 'Agriculture', 'Fishing', 'Forestry'], ['sector:agriculture_agri_business']),
    ...
    r('sector', 'en', ['Hospitality & Hotel', 'Hospitality', 'Hotel', 'Tourism & Travel', 'Tourism', 'Travel'], ['sector:hospitality']),
    ...
    r('sector', 'en', ['Advertising, Media & Communications', 'Advertising', 'Media', 'Communications'], ['sector:media_advertising']),
    ...
    r('sector', 'en', ['Entertainment, Events & Sport', 'Entertainment', 'Events', 'Sport'], ['sector:media_advertising']),
    ...
    r('job_function', 'en', ['Creative & Design'], ['job_function:architecture_design', 'job_function:arts_entertainment']),
    r('job_function', 'en', ['Creative'], ['job_function:arts_entertainment']),
    r('job_function', 'en', ['Design'], ['job_function:architecture_design']),
    r('job_function', 'en', ['Customer Service & Support', 'Customer Service', 'Support'], ['job_function:customer_support']),
    r('job_function', 'en', ['Research, Teaching & Training'], ['job_function:research_development', 'job_function:education_training']),
    ...
    r('job_function', 'en', ['Supply Chain & Procurement'], ['job_function:operations_logistics', 'job_function:procurement']),
    ...
    r('job_function', 'en', ['Marketing & Communications', 'Marketing', 'Communications'], ['job_function:marketing_communications']),
    ...
    r('job_function', 'en', ['Consulting', 'Strategy'], ['job_function:consulting_strategy']),
    r('job_function', 'en', ['Community & Social Services', 'Community', 'Social Services'], ['job_function:community_social_services']),
    r('job_function', 'en', ['Quality Control & Assurance', 'Quality Control', 'Quality Assurance', 'Assurance'], ['job_function:quality_assurance']),
    r('job_function', 'en', ['Retail'], ['job_function:sales_commerce']),
    r('job_function', 'en', ['Management & Business Development'], ['job_function:management', 'job_function:business_development']),
    ...
    r('job_function', 'en', ['Estate Agents', 'Property Management'], ['job_function:sales_commerce']),
    r('job_function', 'en', ['Building & Architecture'], ['job_function:architecture_design', 'job_function:skilled_trades']),
    ...
    r('sector', 'ro', ['Transport / Logistică / Import - Export'], ['sector:transportation', 'sector:warehouse_logistics']),
    ...
    r('job_function', 'ro', ['Administrativ / Logistică'], ['job_function:administration', 'job_function:operations_logistics']),
    ...
    r('job_function', 'ro', ['Audit / Consultanță'], ['job_function:finance_accounting', 'job_function:consulting_strategy']),
    ...
    r('job_function', 'ro', ['Educație / Training / Arte'], ['job_function:education_training', 'job_function:arts_entertainment']),
    ...
    r('job_function', 'ro', ['IT Hardware', 'IT Software', 'Internet / e-Commerce', 'Telecomunicații'], ['job_function:it_software_data']),
    ...
    r('job_function', 'ro', ['Proiectare civilă / industrială'], ['job_function:architecture_design', 'job_function:engineering']),
    ...
    r('job_function', 'hu', ['Fizikai, Segéd, Betanított munka', 'Betanított munka', 'Egyéb fizikai munka'], ['job_function:physical_manual_work']),
    ...
    r('job_function', 'hu', ['Marketing, Média, PR'], ['job_function:marketing_communications', 'job_function:arts_entertainment']),
    r('job_function', 'hu', ['Anyagmozgatás, Rakodás'], ['job_function:operations_logistics', 'job_function:physical_manual_work']),
    ...
    r('job_function', 'hu', ['Oktatás, Tudomány, Sport'], ['job_function:education_training', 'job_function:research_development']),
    ...
    r('job_function', 'hu', ['Szállítás, Beszerzés, Logisztika'], ['job_function:transport_driving', 'job_function:operations_logistics', 'job_function:procurement']),
    ...
    r('job_function', 'hu', ['Szobalány/Szobafiú'], ['job_function:hospitality_food_service', 'job_function:animal_care_childcare_cleaning']),
    ...
    r('job_function', 'et', ['Haridus / Teadus'], ['job_function:education_training', 'job_function:research_development']),
    ...
    r('job_function', 'et', ['Koolitus / Personalitöö'], ['job_function:education_training', 'job_function:human_resources']),
    ...
    r('job_function', 'et', ['Meedia / Loomemajandus / Tõlkimine'], ['job_function:marketing_communications', 'job_function:arts_entertainment']),
    ...
    r('job_function', 'et', ['Tervishoid / Sotsiaaltöö'], ['job_function:healthcare', 'job_function:community_social_services']),
    r('job_function', 'et', ['Toitlustus'], ['job_function:hospitality_food_service']),
    r('job_function', 'et', ['Transport / Logistika'], ['job_function:transport_driving', 'job_function:operations_logistics']),
    r('job_function', 'et', ['Turism / Hotellindus / Iluteenused'], ['job_function:hospitality_food_service', 'job_function:healthcare']),
