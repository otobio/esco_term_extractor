...
import { FAMILY_STRUCTURE_QUERY_VOCABULARY, familyStructureVocabularyMatchesForToken, familyStructureVocabularyValuesByDimension } from '../../src/runtime/occupation-family-structure-vocabulary.js';
...
test('family structure vocabulary merges reviewed locale-scoped seed rows', () => {
    const romanian = familyStructureVocabularyValuesByDimension(['gestionar', 'inginer', 'constructii', 'utilaje', 'coordonator', 'reparatii', 'manipulant'], 'ro');
...
test('family structure vocabulary reads Romanian nursing phrases as role-level evidence', () => {
    const values = familyStructureVocabularyValuesByDimension(['asistent', 'medical', 'generalist', 'asistent medical', 'asistent medical generalist'], 'ro');
