...
function hungarianCandidateTieBreak(left, right, terms) {
...
function hungarianLocalContextStrength(terms, termIndex) {
    let score = 0;
...
function hungarianOccupationMorphologyScore(token) {
    if (token.length < 5) {
        return 0;
    }
...
function hungarianAdjectivePenalty(token) {
