...
export function getDefaultBucketConfigs(): Record<BucketName, BucketConfig> {
  return structuredClone(DEFAULTS);
}

export function resolveBucketConfig(bucket: BucketName, overrides?: Partial<BucketConfig>): BucketConfig {
