...
import {
  rankFamilyTop2V2,
  type FamilyTop2V2ClassifierQuery,
  type FamilyTop2V2Result,
  type FamilyTop2V2FamilyHit
} from './rank-family-top2-v2-core.js';
...
async function main(): Promise<void> {
  ...
  const query: FamilyTop2V2ClassifierQuery = {
    preparedQuery,
...
function formatResult(result: FamilyTop2V2Result, format: OutputFormat): string {
  if (format === 'json') {
...
function formatFamilyHit(family: FamilyTop2V2FamilyHit): string {
  return [
