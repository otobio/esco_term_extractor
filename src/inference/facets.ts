...
const OCCUPATION_FAMILY_RECORDS: readonly OccupationFamilyAliasRecord[] = [
  ...
  { locale: 'ro', surfaces: ['Achiziții'], slugs: ['sales_and_purchasing_agents_and_brokers'] },
  { locale: 'ro', surfaces: ['Administrativ / Logistică'], slugs: ['general_office_clerks'] },
  { locale: 'ro', surfaces: ['Agricultură'], slugs: ['mixed_crop_and_animal_producers'] },
  { locale: 'ro', surfaces: ['Alimentație / HoReCa'], slugs: ['cooks'] },
  { locale: 'ro', surfaces: ['Arhitectură / Design interior'], slugs: ['architects_planners_surveyors_and_designers'] },
  { locale: 'ro', surfaces: ['Asigurări'], slugs: ['finance_professionals'] },
  { locale: 'ro', surfaces: ['Au pair / Babysitter / Curățenie'], slugs: ['child_care_workers_and_teachers_aides'] },
  { locale: 'ro', surfaces: ['Audit / Consultanță'], slugs: ['finance_professionals'] },
  { locale: 'ro', surfaces: ['Auto / Echipamente'], slugs: ['machinery_mechanics_and_repairers'] },
  { locale: 'ro', surfaces: ['Automatizări'], slugs: ['electrotechnology_engineers'] },
  { locale: 'ro', surfaces: ['Bănci'], slugs: ['finance_professionals'] },
  { locale: 'ro', surfaces: ['Cercetare - dezvoltare'], slugs: ['life_science_professionals'] },
  { locale: 'ro', surfaces: ['Chimie / Biochimie'], slugs: ['life_science_professionals'] },
  { locale: 'ro', surfaces: ['Confecții / Design vestimentar'], slugs: ['garment_and_related_trades_workers'] },
  { locale: 'ro', surfaces: ['Construcții / Instalații'], slugs: ['building_frame_and_related_trades_workers'] },
  { locale: 'ro', surfaces: ['Controlul calității'], slugs: ['physical_and_engineering_science_technicians'] },
  { locale: 'ro', surfaces: ['Crewing / Casino / Entertainment'], slugs: ['creative_and_performing_artists'] },
  { locale: 'ro', surfaces: ['Educație / Training / Arte'], slugs: ['other_teaching_professionals'] },
  { locale: 'ro', surfaces: ['Farmacie'], slugs: ['medical_and_pharmaceutical_technicians'] },
  { locale: 'ro', surfaces: ['Financiar / Contabilitate'], slugs: ['finance_professionals'] },
  { locale: 'ro', surfaces: ['Funcții publice'], slugs: ['regulatory_government_associate_professionals'] },
  { locale: 'ro', surfaces: ['Grafică / Webdesign / DTP'], slugs: ['creative_and_performing_artists'] },
  { locale: 'ro', surfaces: ['Imobiliare'], slugs: ['sales_and_purchasing_agents_and_brokers'] },
  { locale: 'ro', surfaces: ['Import - export'], slugs: ['sales_and_purchasing_agents_and_brokers'] },
  { locale: 'ro', surfaces: ['Inginerie'], slugs: ['engineering_professionals_excluding_electrotechnology'] },
  { locale: 'ro', surfaces: ['Instalații electrice'], slugs: ['electrical_equipment_installers_and_repairers'] },
  { locale: 'ro', surfaces: ['Instalații sanitare'], slugs: ['building_finishers_and_related_trades_workers'] },
  { locale: 'ro', surfaces: ['Instalații termice'], slugs: ['building_finishers_and_related_trades_workers'] },
  { locale: 'ro', surfaces: ['Internet / e-Commerce'], slugs: ['software_and_applications_developers_and_analysts'] },
  {
    locale: 'ro',
    surfaces: ['IT Hardware'],
    slugs: ['information_and_communications_technology_operations_and_user_support_technicians'],
  },
  { locale: 'ro', surfaces: ['IT Software'], slugs: ['software_and_applications_developers_and_analysts'] },
  { locale: 'ro', surfaces: ['Juridic'], slugs: ['legal_professionals'] },
  { locale: 'ro', surfaces: ['Jurnalism / Editorial'], slugs: ['authors_journalists_and_linguists'] },
  { locale: 'ro', surfaces: ['Management'], slugs: ['business_services_and_administration_managers'] },
  { locale: 'ro', surfaces: ['Marketing'], slugs: ['sales_marketing_and_public_relations_professionals'] },
  { locale: 'ro', surfaces: ['Medicină alternativă'], slugs: ['traditional_and_complementary_medicine_professionals'] },
  { locale: 'ro', surfaces: ['Medicină umană'], slugs: ['medical_doctors'] },
  { locale: 'ro', surfaces: ['Medicină veterinară'], slugs: ['veterinarians'] },
  { locale: 'ro', surfaces: ['Merchandising / Promoteri'], slugs: ['other_sales_workers'] },
  { locale: 'ro', surfaces: ['MLM / Vânzări directe'], slugs: ['other_sales_workers'] },
  { locale: 'ro', surfaces: ['Naval / Aeronautic'], slugs: ['ship_and_aircraft_controllers_and_technicians'] },
  { locale: 'ro', surfaces: ['Office / Back-office / Secretariat'], slugs: ['secretaries_general'] },
  { locale: 'ro', surfaces: ['ONG / Voluntariat'], slugs: ['social_and_religious_professionals'] },
  { locale: 'ro', surfaces: ['Pază și protecție / Militar'], slugs: ['protective_services_workers'] },
  { locale: 'ro', surfaces: ['Personal calificat'], slugs: ['other_craft_and_related_workers'] },
  { locale: 'ro', surfaces: ['Petrol / Gaze'], slugs: ['mining_and_mineral_processing_plant_operators'] },
  {
    locale: 'ro',
    surfaces: ['Prelucrarea lemnului / PVC'],
    slugs: ['wood_treaters_cabinet_makers_and_related_trades_workers'],
  },
  { locale: 'ro', surfaces: ['Producție'], slugs: ['other_stationary_plant_and_machine_operators'] },
  {
    locale: 'ro',
    surfaces: ['Proiectare civilă / industrială'],
    slugs: ['architects_planners_surveyors_and_designers'],
  },
  { locale: 'ro', surfaces: ['Project Management'], slugs: ['business_services_and_administration_managers'] },
  { locale: 'ro', surfaces: ['Protecția mediului'], slugs: ['life_science_professionals'] },
  { locale: 'ro', surfaces: ['Protecția muncii'], slugs: ['regulatory_government_associate_professionals'] },
  { locale: 'ro', surfaces: ['Publicitate'], slugs: ['sales_marketing_and_public_relations_professionals'] },
  { locale: 'ro', surfaces: ['Relații clienți / Call center'], slugs: ['client_information_workers'] },
  { locale: 'ro', surfaces: ['Relații publice'], slugs: ['sales_marketing_and_public_relations_professionals'] },
  { locale: 'ro', surfaces: ['Resurse umane / Psihologie'], slugs: ['administration_professionals'] },
  { locale: 'ro', surfaces: ['Saloane / Clinici frumusețe'], slugs: ['hairdressers_beauticians_and_related_workers'] },
  { locale: 'ro', surfaces: ['Service / Reparații'], slugs: ['machinery_mechanics_and_repairers'] },
  { locale: 'ro', surfaces: ['Specialiști / Tehnicieni'], slugs: ['physical_and_engineering_science_technicians'] },
  { locale: 'ro', surfaces: ['Sport / Wellness'], slugs: ['sports_and_fitness_workers'] },
  { locale: 'ro', surfaces: ['Statistică / Matematică'], slugs: ['mathematicians_actuaries_and_statisticians'] },
  { locale: 'ro', surfaces: ['Telecomunicații'], slugs: ['telecommunications_and_broadcasting_technicians'] },
  { locale: 'ro', surfaces: ['Tipografii / Edituri'], slugs: ['printing_trades_workers'] },
  { locale: 'ro', surfaces: ['Traduceri'], slugs: ['authors_journalists_and_linguists'] },
  { locale: 'ro', surfaces: ['Transport / Distribuție'], slugs: ['transport_and_storage_labourers'] },
  { locale: 'ro', surfaces: ['Turism / Hotel staff'], slugs: ['hotel_and_restaurant_managers'] },
  { locale: 'ro', surfaces: ['Vânzări'], slugs: ['shop_salespersons'] },
];
