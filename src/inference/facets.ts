...
const RECORDS: readonly FacetAliasRecord[] = [
  ...
  r(
    'company_type',
    'en',
    ['Farming & Agriculture', 'Agriculture, Fishing & Forestry'],
  ...
  r(
    ...
    ['company_type:professional_services', 'company_type:banking_financial_services'],
  ),
  ...
  r(
    ...
    ['company_type:hospital_healthcare', 'company_type:pharma_biotech'],
  ),
  ...
  r(
    ...
    ['company_type:banking_financial_services', 'company_type:insurance'],
  ),
  ...
  r(
    ...
    'en',
    ['Shipping & Logistics'],
    ['company_type:warehouse_logistics', 'company_type:transportation'],
  ),
  r(
    'company_type',
    'en',
    ['Manufacturing & Warehousing'],
    ['company_type:manufacturing', 'company_type:warehouse_logistics'],
  ),
  r(
    'company_type',
    'en',
    ['Advertising, Media & Communications', 'Digital, Media & Communications'],
  ...
  r(
    'company_type',
    'ro',
    ['Servicii alimentare & catering'],
    ['company_type:hospitality', 'company_type:food_beverage'],
  ),
  ...
  r(
    ...
    ['company_type:retailer', 'company_type:food_beverage'],
  ),
  r(
    'company_type',
    'ro',
    ['Transport si logistica'],
    ['company_type:transportation', 'company_type:warehouse_logistics'],
  ),
  ...
  r(
    ...
    'ro',
    ['Media / Internet'],
    ['company_type:media_advertising', 'company_type:information_technology'],
  ),
  ...
  r(
    ...
    ['company_type:hospitality', 'company_type:media_advertising'],
  ),
  ...
  r(
    'company_type',
    'ro',
    ['Instalații electrice', 'Instalații sanitare', 'Instalații termice'],
  ...
  r(
    'company_type',
    'ro',
    ['Medicină alternativă', 'Medicină umană', 'Medicină veterinară'],
  ...
  r(
    ...
    ['company_type:construction', 'company_type:industrial_services'],
  ),
  ...
  r(
    'company_type',
    'et',
    ['Pangandus, finants ja kindlustus'],
    ['company_type:banking_financial_services', 'company_type:insurance'],
  ),
  ...
  r(
    ...
    ['company_type:energy', 'company_type:utility_provider'],
  ),
  ...
  r(
    'company_type',
    'et',
    ['Hotellindus ja toitlustus', 'Majutus ja toitlustus'],
    ['company_type:hospitality', 'company_type:food_beverage'],
  ),
  ...
  r(
    'company_type',
    'et',
    ['IT ja telekommunikatsioon', 'IT / Telekom'],
    ['company_type:information_technology', 'company_type:telecom'],
  ),
  ...
  r(
    'company_type',
    'et',
    ['Transport ja logistika', 'Tarneahel ja hanked'],
    ['company_type:transportation', 'company_type:warehouse_logistics'],
  ),
  ...
  r(
    'company_type',
    'et',
    ['Reklaam, meedia ja kommunikatsioon', 'Turundus ja kommunikatsioon'],
    ['company_type:media_advertising'],
  ),
  ...
  r(
    'company_type',
    'et',
    ['Klienditeenindus ja tugi', 'Kõnekeskus / BPO'],
    ['company_type:outsourcing_shared_services'],
  ),
  r(
    'company_type',
    'et',
    ['Raamatupidamine, audit ja finants'],
    ['company_type:professional_services', 'company_type:banking_financial_services'],
  ),
  ...
  r(
    ...
    ['company_type:industrial_services', 'company_type:telecom'],
  ),
  ...
  r(
    ...
    ['company_type:hospitality', 'company_type:hospital_healthcare'],
  ),
  ...
  r(
    'company_type',
    'hu',
    ['IT üzemeltetés, Telekom', 'IT Telekom'],
    ['company_type:information_technology', 'company_type:telecom'],
  ),
  ...
  r(
    ...
    ['company_type:agriculture_agri_business', 'company_type:nonprofit'],
  ),
  ...
  for (const record of records) {
    ...
    for (const surface of record.surfaces) {
      for (const variant of facetSurfaceVariants(surface, record.locale)) {
        ...
        if (prev?.some((x) => x.requiredAcronym === entry.requiredAcronym)) continue;
